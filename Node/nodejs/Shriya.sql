...
--
-- Host: localhost
-- Generation Time: Dec 22, 2021 at 08:50 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `sm_get` (IN `grp` VARCHAR(10))  begin select * from Students where Hobby = 'grp'; end$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get` ()  begin select * from Students; end$$
...
(10, 'Avani', 'Patel', 971261781, 'ws@gmail.com');
...
(5, 'Soccer', 895, 'Adidas'),
(6, 'Wrist band', 125, 'Adidas'),
(7, 'Towel', 564, 'Puma'),
(8, 'Socks', 455, 'Fastrack'),
(9, 'Badminton', 593, 'Puma'),
(10, 'Tshirt', 894, 'Adidas');
...
INSERT INTO `students` (`s_id`, `s_name`, `s_email`, `s_pwd`) VALUES
(1, 'shriya', 's@gmail.com', '123'),
(3, 'avani', 'a@gmail.com', '123');
